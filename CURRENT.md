...
- 2026-05-07: Flash attempt succeeded over `/dev/ttyUSB0`, but upload target MAC was `D4:E9:F4:BA:6F:CC`. The live AP/DMX node at `10.0.0.1` reports MAC `D4:E9:F4:BC:5A:64` and old manifest routes, so the connected USB board was not the light-connected node. Need plug/flash `D4:E9:F4:BC:5A:64` or remove the other ESP before upload.
